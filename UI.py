...
def create_slider(maximum, minimum):
    slider = QSlider()
...
class ImageLabel(QLabel):
    def __init__(self, MainWindow, parent=None):
        ...
        self.magnitude_real_slider = create_slider(200, 10)
        self.phase_imaginary_slider = create_slider(200, 10)
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.select_region_slider = create_slider(300, 10)
        ...
        self.main_controls_layout.addWidget(self.select_region_slider, 2, 2, 1, 2)
